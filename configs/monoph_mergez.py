...
monophoton_category = {
	    'name':"monophoton"
		  ...
		  # Signal Region
                  ...
                  ,"dimu-phoPtHighMet-vvg"        :['dilep','vvg',1,0]
                  ,"dimu-phoPtHighMet-zjets"      :['dilep','zjets',1,0]
                  ,"dimu-phoPtHighMet-top"        :['dilep','top',1,0]
                  ,"dimu-phoPtHighMet-zg"         :['dilep','zg',1,0]
                  ,"dimu-phoPtHighMet-data_obs"   :['dilep','data',0,0]
                   
                  # Dielectron Control Region
                  ,"diel-phoPtHighMet-vvg"        :['dilep','vvg',1,0]
                  ,"diel-phoPtHighMet-top"        :['dilep','top',1,0]
                  ,"diel-phoPtHighMet-zjets"      :['dilep','zjets',1,0]
                  ,"diel-phoPtHighMet-zg"         :['dilep','zg',1,0]
