...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  WlnScales.Divide(controlmc);  
  # for iBin in range(1, WlnScales.GetNbinsX()+1):
  #   WlnScales.SetBinError(iBin, 0.)
  _fOut.WriteTObject(WlnScales)  # always write out to the directory 
  ...
  CRs[0].addUncorrStatSysts(targetmc, WlnScales, "monolep", "monolep", cid, _fOut)
...
def lepSFSystSetup(_wspace, _fin, _fOut, nam):
  ...
  controlmc_SFUp    = _fin.Get("monolep_wg_muonSFUp")  
  controlmc_SFDown  = _fin.Get("monolep_wg_muonSFDown")  
